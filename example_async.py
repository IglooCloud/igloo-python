from igloo import Client, User, Device, FloatValue
import asyncio
...
async def main():
    ...
    device = Device(client, "39fc078e-a94d-4184-8008-3e97750f5e73")
    await asyncio.gather(monitor_humidity(client), monitor_temperature(client), device.keepOnline())
